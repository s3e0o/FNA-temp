...
import education from "../../../assets/images/retirement.jpg";

export default function RetirementDeets() {
  const [active, setActive] = useState(null);

  useEffect(() => {
    document.title = "Retirement Service Details | Financial Needs Analysis";
  }, []);
